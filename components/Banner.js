...
const Banner = () => {
  return (
    <section className="mt-24 w-full mx-auto max-w-7xl flex sm:flex-row flex-col bg-blue-200 justify-between lg:items-end items-center z-10 bg-blue px-7 py-9">
